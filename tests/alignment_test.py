...
def test_alignment():
	...
	assert(metadata_w_partitions.iloc[0,7] == "nomenclature_code_" + "%s" % (datetime.date.today()))
	assert(metadata_w_partitions.iloc[0,8] == "MST-21x1.0") 
	assert(metadata_w_partitions.iloc[0,11] == "QUAL_called")
	assert(metadata_w_partitions.iloc[12,7] == "C2-C2-C2.1")        
