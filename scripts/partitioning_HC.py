...
class HC:
	...
	def run(self):
		...
		clustering, cluster_details = hierarchical_clustering(self.df_dist, log)
...
def hierarchical_clustering(df_dist, log):
...
if __name__ == "__main__":
	...
	clustering, cluster_details = hierarchical_clustering(df_dist, log)
